...
//! \file	raidnpdatdecvolctrl.hpp
//! \brief	Definition of the RAID NP controller with data declustering.
//!	\deprecated		Use the PerfParityCtrl.

#ifndef _OGSS_RAIDNPDATDECVOLCTRL_HPP_
#define _OGSS_RAIDNPDATDECVOLCTRL_HPP_
...
//! \brief	Controller for a RAID NP using data declustering.
class RAIDNPDatDecVolCtrl:
public VolumeController {
public:
	friend class UT_RAIDNPDatDecVolCtrl;
...
class UT_RAIDNPDatDecVolCtrl:
public UnitaryTest <UT_RAIDNPDatDecVolCtrl> {
public:
	UT_RAIDNPDatDecVolCtrl (
