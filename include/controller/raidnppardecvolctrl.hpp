...
//! \file	raidnppardecvolctrl.hpp
//! \brief	Definition of the RAID NP controller with parity declustering.
//!	\deprecated		Use the PerfParityCtrl.

#ifndef _OGSS_RAIDNPPARDECVOLCTRL_HPP_
#define _OGSS_RAIDNPPARDECVOLCTRL_HPP_
...
//! \brief	Controller for a RAID NP using parity declustering.
class RAIDNPParDecVolCtrl:
public VolumeController {
public:
	friend class UT_RAIDNPParDecVolCtrl;
...
class UT_RAIDNPParDecVolCtrl:
public UnitaryTest <UT_RAIDNPParDecVolCtrl> {
public:
	UT_RAIDNPParDecVolCtrl (
