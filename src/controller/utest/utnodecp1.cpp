...
UT_RAIDNPNoDecVolCtrl::largeStripeW1PRequest () {
	...
	if (sr.at (3) ._size != 4 || sr.at (3) ._deviceAddress != 4
		|| sr.at (3) ._idxDevice != 0 || sr.at (3) ._type != RQT_WRITE)
			return false;
	if (sr.at (4) ._size != 4 || sr.at (4) ._deviceAddress != 4
		|| sr.at (4) ._idxDevice != 1 || sr.at (4) ._type != RQT_WRITE)
			return false;
	if (sr.at (5) ._size != 2 || sr.at (5) ._deviceAddress != 4
		|| sr.at (5) ._idxDevice != 2 || sr.at (5) ._type != RQT_WRITE)
			return false;
	if (sr.at (6) ._size != 4 || sr.at (6) ._deviceAddress != 4
		|| sr.at (6) ._idxDevice != 4 || sr.at (6) ._type != RQT_WRITE)
			return false;
...
UT_RAIDNPNoDecVolCtrl::twoStripeW1PRequest () {
	...
	if (sr.at (1) ._size != 2 || sr.at (1) ._deviceAddress != 0
		|| sr.at (1) ._idxDevice != 4 || sr.at (1) ._type != RQT_READ)
			return false;
	if (sr.at (2) ._size != 4 || sr.at (2) ._deviceAddress != 4
		|| sr.at (2) ._idxDevice != 0 || sr.at (2) ._type != RQT_READ)
			return false;
	if (sr.at (3) ._size != 2 || sr.at (3) ._deviceAddress != 4
		|| sr.at (3) ._idxDevice != 1 || sr.at (3) ._type != RQT_READ)
			return false;
	if (sr.at (4) ._size != 4 || sr.at (4) ._deviceAddress != 4
	...
	if (sr.at (10) ._size != 4 || sr.at (10) ._deviceAddress != 4
		|| sr.at (10) ._idxDevice != 0 || sr.at (10) ._type != RQT_WRITE)
			return false;
	if (sr.at (11) ._size != 2 || sr.at (11) ._deviceAddress != 4
		|| sr.at (11) ._idxDevice != 1 || sr.at (11) ._type != RQT_WRITE)
			return false;
	if (sr.at (12) ._size != 4 || sr.at (12) ._deviceAddress != 4
		|| sr.at (12) ._idxDevice != 4 || sr.at (12) ._type != RQT_WRITE)
			return false;
...
UT_RAIDNPNoDecVolCtrl::moreStripeW1PRequest () {
	...
	if (sr.at (8) ._size != 4 || sr.at (8) ._deviceAddress != 4
		|| sr.at (8) ._idxDevice != 0 || sr.at (8) ._type != RQT_WRITE)
			return false;
	if (sr.at (9) ._size != 4 || sr.at (9) ._deviceAddress != 4
		|| sr.at (9) ._idxDevice != 1 || sr.at (9) ._type != RQT_WRITE)
			return false;
	if (sr.at (10) ._size != 4 || sr.at (10) ._deviceAddress != 4
		|| sr.at (10) ._idxDevice != 2 || sr.at (10) ._type != RQT_WRITE)
			return false;
	if (sr.at (11) ._size != 4 || sr.at (11) ._deviceAddress != 4
		|| sr.at (11) ._idxDevice != 3 || sr.at (11) ._type != RQT_WRITE)
			return false;
	if (sr.at (12) ._size != 4 || sr.at (12) ._deviceAddress != 4
		|| sr.at (12) ._idxDevice != 4 || sr.at (12) ._type != RQT_WRITE)
			return false;
	...
	if (sr.at (14) ._size != 2 || sr.at (14) ._deviceAddress != 8
		|| sr.at (14) ._idxDevice != 4 || sr.at (14) ._type != RQT_WRITE)
			return false;
