...
UT_RAIDNPNoDecVolCtrl::largeStripeW2PRequest () {
	...
	if (sr.at (6) ._size != 2 || sr.at (6) ._deviceAddress != 4
		|| sr.at (6) ._idxDevice != 2 || sr.at (6) ._type != RQT_WRITE)
			return false;
	...
	if (sr.at (8) ._size != 4 || sr.at (8) ._deviceAddress != 4
		|| sr.at (8) ._idxDevice != 5 || sr.at (8) ._type != RQT_WRITE)
			return false;
...
UT_RAIDNPNoDecVolCtrl::fullStripeW2PRequest () {
	...
	if (sr.at (0) ._size != 4 || sr.at (0) ._deviceAddress != 8
		|| sr.at (0) ._idxDevice != 0 || sr.at (0) ._type != RQT_WRITE)
			return false;
	if (sr.at (1) ._size != 4 || sr.at (1) ._deviceAddress != 8
		|| sr.at (1) ._idxDevice != 1 || sr.at (1) ._type != RQT_WRITE)
			return false;
	if (sr.at (2) ._size != 4 || sr.at (2) ._deviceAddress != 8
		|| sr.at (2) ._idxDevice != 2 || sr.at (2) ._type != RQT_WRITE)
			return false;
	if (sr.at (3) ._size != 4 || sr.at (3) ._deviceAddress != 8
		|| sr.at (3) ._idxDevice != 3 || sr.at (3) ._type != RQT_WRITE)
			return false;
...
UT_RAIDNPNoDecVolCtrl::twoStripeW2PRequest () {
	...
	if (sr.at (4) ._size != 2 || sr.at (4) ._deviceAddress != 4
		|| sr.at (4) ._idxDevice != 1 || sr.at (4) ._type != RQT_READ)
			return false;
	if (sr.at (5) ._size != 4 || sr.at (5) ._deviceAddress != 4
		|| sr.at (5) ._idxDevice != 4 || sr.at (5) ._type != RQT_READ)
			return false;
	if (sr.at (6) ._size != 4 || sr.at (6) ._deviceAddress != 4
		|| sr.at (6) ._idxDevice != 5 || sr.at (6) ._type != RQT_READ)
			return false;
	...
	if (sr.at (13) ._size != 4 || sr.at (13) ._deviceAddress != 4
		|| sr.at (13) ._idxDevice != 0 || sr.at (13) ._type != RQT_WRITE)
			return false;
	if (sr.at (14) ._size != 2 || sr.at (14) ._deviceAddress != 4
		|| sr.at (14) ._idxDevice != 1 || sr.at (14) ._type != RQT_WRITE)
			return false;
	if (sr.at (15) ._size != 4 || sr.at (15) ._deviceAddress != 4
		|| sr.at (15) ._idxDevice != 4 || sr.at (15) ._type != RQT_WRITE)
			return false;
	if (sr.at (16) ._size != 4 || sr.at (16) ._deviceAddress != 4
		|| sr.at (16) ._idxDevice != 5 || sr.at (16) ._type != RQT_WRITE)
			return false;
...
UT_RAIDNPNoDecVolCtrl::moreStripeW2PRequest () {
	...
	if (sr.at (12) ._size != 4 || sr.at (12) ._deviceAddress != 4
		|| sr.at (12) ._idxDevice != 1 || sr.at (12) ._type != RQT_WRITE)
			return false;
	if (sr.at (13) ._size != 4 || sr.at (13) ._deviceAddress != 4
		|| sr.at (13) ._idxDevice != 2 || sr.at (13) ._type != RQT_WRITE)
			return false;
	if (sr.at (14) ._size != 4 || sr.at (14) ._deviceAddress != 4
		|| sr.at (14) ._idxDevice != 3 || sr.at (14) ._type != RQT_WRITE)
			return false;
	if (sr.at (15) ._size != 4 || sr.at (15) ._deviceAddress != 4
		|| sr.at (15) ._idxDevice != 4 || sr.at (15) ._type != RQT_WRITE)
			return false;
	...
	if (sr.at (17) ._size != 2 || sr.at (17) ._deviceAddress != 8
		|| sr.at (17) ._idxDevice != 0 || sr.at (17) ._type != RQT_WRITE)
			return false;
	if (sr.at (18) ._size != 2 || sr.at (18) ._deviceAddress != 8
		|| sr.at (18) ._idxDevice != 4 || sr.at (18) ._type != RQT_WRITE)
			return false;
	if (sr.at (19) ._size != 2 || sr.at (19) ._deviceAddress != 8
		|| sr.at (19) ._idxDevice != 5 || sr.at (19) ._type != RQT_WRITE)
			return false;
