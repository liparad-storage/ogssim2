...
UT_RAIDNPParDecVolCtrl::smallStripeR2PRequest () {
	RAIDNPParDecVolCtrl		module ( (Volume () ), (Device () ) );
	Request					req;
	vector <Request>		sr;
...
UT_RAIDNPParDecVolCtrl::fullStripeR2PRequest () {
	...
	if (sr.at (3) ._size != 4 || sr.at (3) ._deviceAddress != 8
		|| sr.at (3) ._idxDevice != 5) return false;
...
UT_RAIDNPParDecVolCtrl::moreStripeR2PRequest () {
	...
	if (sr.at (5) ._size != 4 || sr.at (5) ._deviceAddress != 4
		|| sr.at (5) ._idxDevice != 5) return false;
...
UT_RAIDNPParDecVolCtrl::largeStripeW2PRequest () {
	...
	if (sr.at (0) ._size != 2 || sr.at (0) ._deviceAddress != 6
		|| sr.at (0) ._idxDevice != 2 || sr.at (0) ._type != RQT_READ)
			return false;
	if (sr.at (1) ._size != 4 || sr.at (1) ._deviceAddress != 4
		|| sr.at (1) ._idxDevice != 5 || sr.at (1) ._type != RQT_READ)
			return false;
	if (sr.at (2) ._size != 4 || sr.at (2) ._deviceAddress != 4
...
UT_RAIDNPParDecVolCtrl::fullStripeW2PRequest () {
	...
	if (sr.at (1) ._size != 4 || sr.at (1) ._deviceAddress != 8
		|| sr.at (1) ._idxDevice != 1 || sr.at (1) ._type != RQT_WRITE)
			return false;
	if (sr.at (2) ._size != 4 || sr.at (2) ._deviceAddress != 8
		|| sr.at (2) ._idxDevice != 4 || sr.at (2) ._type != RQT_WRITE)
			return false;
	if (sr.at (3) ._size != 4 || sr.at (3) ._deviceAddress != 8
		|| sr.at (3) ._idxDevice != 5 || sr.at (3) ._type != RQT_WRITE)
			return false;
...
UT_RAIDNPParDecVolCtrl::moreStripeW2PRequest () {
	...
	if (sr.at (14) ._size != 4 || sr.at (14) ._deviceAddress != 4
		|| sr.at (14) ._idxDevice != 5 || sr.at (14) ._type != RQT_WRITE)
			return false;
	if (sr.at (15) ._size != 4 || sr.at (15) ._deviceAddress != 4
		|| sr.at (15) ._idxDevice != 3 || sr.at (15) ._type != RQT_WRITE)
			return false;
